...
public class DictUtility {
    ...
    ArrayList<ArrayList<Integer>> wordCountMap = new ArrayList<>();

    public DictUtility(ArrayList<ArrayList<Character>> board) {
        try {
            ...
            wordSearch = new FindAllWords(board);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }

        List<Set<String>> allWordSets = this.findAllWords();
        ...
        this.wordCountMap = this.getLetterWordCount(allWordSets);
    }

    private ArrayList<ArrayList<Integer>> getLetterWordCount(List<Set<String>> allWordSets) {
        return this.wordSearch.getLetterWordCount(allWordSets);
    }
    ...
    public int getFoundWordsCount() {
        return this.foundRegWords.size();
    }

    public int getBonusWordsFoundCount() {
        return this.foundBonusWords.size();
    }

    private List<Set<String>> findAllWords() {
        return wordSearch.findWords();
    }
